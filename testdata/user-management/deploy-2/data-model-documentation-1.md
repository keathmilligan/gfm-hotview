...
date: "2026-Apr"
component: "deploy-2"
tags: ["recommendation-engine", "src"]
---
...
- PagerDuty escalation policy ID: `P6367`
...
1. `deployctl lock --env prod --reason 'Carla Reyes'`
2. `deployctl canary --env prod --version 387.6.39`
