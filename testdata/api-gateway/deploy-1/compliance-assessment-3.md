...
date: "2026-May"
component: "deploy-1"
tags: ["analytics-dashboard", "tests"]
---
...
- PagerDuty escalation policy ID: `P7910`
...
1. `deployctl lock --env prod --reason 'Alice Chen'`
2. `deployctl canary --env prod --version 241.5.93`
