...
date: "2026-Mar"
component: "deploy-3"
tags: ["recommendation-engine", "policies"]
---
...
- 0. order-management / migrations
- 1. reporting-tool / schemas
- 2. reporting-tool / proposals
- 3. user-management / incidents
...
The following chart summarizes the distribution of performance bottlenecks
across service tiers observed during the benchmarking period.

```mermaid
pie title Performance Bottleneck Distribution
    "DB Queries" : 42
    "Serialization" : 23
    "Network I/O" : 18
    "GC Pauses" : 10
