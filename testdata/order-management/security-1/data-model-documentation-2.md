...
| security_field | VARCHAR(146) | NOT NULL | |
...
|--------|------|-------------|-------|
| id | UUID | PK | auto-generated |
| schemas_field | VARCHAR(90) | NOT NULL | |
| status | ENUM('active','inactive','pending') | NOT NULL | default 'pending' |
| metadata | JSONB | NULLABLE | free-form metadata |
| created_at | TIMESTAMPTZ | NOT NULL DEFAULT now() | server-time |
| updated_at | TIMESTAMPTZ | NOT NULL | maintained by trigger |
...
|--------|------|-------------|-------|
| id | UUID | PK | auto-generated |
| migrations_field | VARCHAR(80) | NOT NULL | |
| status | ENUM('active','inactive','pending') | NOT NULL | default 'pending' |
| metadata | JSONB | NULLABLE | free-form metadata |
| created_at | TIMESTAMPTZ | NOT NULL DEFAULT now() | server-time |
| updated_at | TIMESTAMPTZ | NOT NULL | maintained by trigger |
...
|--------|------|-------------|-------|
| id | UUID | PK | auto-generated |
| migrations_field | VARCHAR(88) | NOT NULL | |
| status | ENUM('active','inactive','pending') | NOT NULL | default 'pending' |
| metadata | JSONB | NULLABLE | free-form metadata |
| created_at | TIMESTAMPTZ | NOT NULL DEFAULT now() | server-time |
| updated_at | TIMESTAMPTZ | NOT NULL | maintained by trigger |
...
|--------|------|-------------|-------|
| id | UUID | PK | auto-generated |
| docs_field | VARCHAR(134) | NOT NULL | |
| status | ENUM('active','inactive','pending') | NOT NULL | default 'pending' |
| metadata | JSONB | NULLABLE | free-form metadata |
| created_at | TIMESTAMPTZ | NOT NULL DEFAULT now() | server-time |
| updated_at | TIMESTAMPTZ | NOT NULL | maintained by trigger |
